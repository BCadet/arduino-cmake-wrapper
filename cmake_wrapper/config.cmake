...
set(HOME_PATH $ENV{TOOLS_PATH} CACHE INTERNAL "")
set(ARDUINO_PACKAGE_MANAGER_PATH "${HOME_PATH}/.arduino15" CACHE INTERNAL "")
set(ARDUINO_PKG_MGR_DL_CACHE "${ARDUINO_PACKAGE_MANAGER_PATH}/staging/packages" CACHE INTERNAL "")
get_filename_component(CMAKE_TOOLCHAIN_PATH ${CMAKE_TOOLCHAIN_FILE} DIRECTORY CACHE INTERNAL "")
list(APPEND CMAKE_MODULE_PATH "${CMAKE_TOOLCHAIN_PATH}" CACHE INTERNAL "")
